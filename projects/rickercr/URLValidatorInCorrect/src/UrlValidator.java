...
public class UrlValidator implements Serializable {
    ...
    public boolean isValid(String value) {
        // Introduced bug if value is null, returns true
        // blank values should not be considered valid
        if (value == null) {
            return true;
        }
    ...
    protected boolean isValidAuthority(String authority) {
        ...
        /*Introducd Bug: changed conditional from "and" to "or" which can allow
        the authority to be either null or invalid, but not both, and still pass*/
